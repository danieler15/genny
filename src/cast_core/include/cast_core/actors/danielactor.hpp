...
#ifndef HEADER_5DA81AB1_1AD0_49BF_BCEE_4DD91431C70B_INCLUDED
#define HEADER_5DA81AB1_1AD0_49BF_BCEE_4DD91431C70B_INCLUDED
 ...
 * ```
 *
 * Or you can fill out the generated workloads/docs/danielactor.yml
 * file with extended documentation. If you do this, please mention
 * that extended documentation can be found in the docs/danielactor.yml
 * file.
 *
 * Owner: TODO (which github team owns this Actor?)
 */
class danielactor : public Actor {
    ...
    // of the work is in the associated `danielactor.cpp` file and its
    // assocated `danielactor_test.cpp` integration-test file.
    //
...
public:
    ...
    // .cpp file.
    //
    explicit danielactor(ActorContext& context);
    ~danielactor() = default;
    ...
    //
    // This is how Genny knows that `Type: danielactor` in workload YAMLs
...
private:
    ...
    // `danielactor.cpp` implementation file.
    //
...
#endif  // HEADER_5DA81AB1_1AD0_49BF_BCEE_4DD91431C70B_INCLUDED
